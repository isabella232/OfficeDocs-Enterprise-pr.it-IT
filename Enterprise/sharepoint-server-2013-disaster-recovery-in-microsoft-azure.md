...
## Utilizzare i servizi infrastruttura di Azure per il ripristino di emergenza
<a name="AZ"> </a>
...
## Guida di orientamento al ripristino di emergenza
<a name="RDmap"> </a>
...
## Fase 1: Progettare l'ambiente di ripristino di emergenza
<a name="Phase1"> </a>
...
## Fase 2: Creare la rete virtuale di Azure e la connessione VPN.
<a name="Phase2"> </a>
...
## Fase 3: Distribuire Active Directory e Domain Name Services nella rete virtuale di Azure
<a name="Phase3"> </a>
...
## Fase 4: Distribuire la farm di ripristino di SharePoint in Azure
<a name="Phase4"> </a>
...
## Fase 5: Configurare DFSR tra le farm
<a name="Phase5"> </a>
...
## Fase 6: Configurare il log shipping nella farm di ripristino
<a name="Phase6"> </a>
...
## Fase 7: Convalidare failover e ripristino
<a name="Phase7"> </a>
...
### Ricerca per indicizzazione dell'origine contenuto
...
## Ambiente del modello di verifica di Microsoft
<a name="POC"> </a>
...
|:-----|:-----|:-----|:-----|
|C  <br/> |80  <br/> |Unità di sistema  <br/> |<Lettera di unità>: \\Programmi\\Microsoft SQL Server  <br/> |
|E  <br/> |80  <br/> |Unità di registro (40 GB)  <br/> |<Lettera di unità>:\\Programmi\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|F  <br/> |80  <br/> |Pagina (36 GB)  <br/> |<Lettera di unità>:\\Programmi\\Microsoft SQL Server\\MSSQL\\DATA  <br/> |
...
|**Lettera di unità**|**Dimensioni**|**Nome della directory**|**Percorso**|
|:-----|:-----|:-----|:-----|
|C  <br/> |80  <br/> |Directory radice dati  <br/> |<Lettera di unità>: \\Programmi\\Microsoft SQL Server  <br/> |
|E  <br/> |500  <br/> |Directory database utente  <br/> |<Lettera di unità>:\\Programmi\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|F  <br/> |500  <br/> |Directory log database utente  <br/> |<Lettera di unità>:\\Programmi\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|G  <br/> |500  <br/> |Directory DB temp  <br/> |<Lettera di unità>:\\Programmi\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|H  <br/> |500  <br/> |Directory log DB temp  <br/> |<Lettera di unità>:\\Programmi\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
...
### L'utilizzo dello Strumento di gestione archivio termini ha causato l'errore "The Managed Metadata Store or Connection is currently not available", in cui si comunica che l'archivio dei metadati gestiti o la connessione non è disponibile al momento.
...
### Errore di creazione del gruppo di disponibilità all'avvio della sessione 'AlwaysOn_health' XEvent in '<nome server>'

Verificare che entrambi i nodi del cluster di failover siano nello stato "Attivo" e non "Sospeso" o "Interrotto". 
  
### Il processo di log shipping di SQL Server ha esito negativo con un errore di accesso negato nel tentativo di connettersi alla condivisione file

Assicurarsi che SQL Server Agent sia in esecuzione con le credenziali di rete, anziché le credenziali predefinite.
  
### Il processo di log shipping di SQL Server indica l'esito positivo, ma i file non vengono copiati
...
### Il servizio Metadati gestiti (o un altro servizio di SharePoint) non si avvia automaticamente dopo l'installazione
...
### Dopo la modifica DNS per l'ambiente di failover di Azure, i browser client continuano a usare il vecchio indirizzo IP del sito di SharePoint

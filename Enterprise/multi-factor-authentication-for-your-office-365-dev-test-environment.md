...
# Autenticazione a più fattori per l'ambiente di sviluppo/test di Office 365
...
## Fase 2: Abilitare e testare l'autenticazione a più fattori per l'account User 2

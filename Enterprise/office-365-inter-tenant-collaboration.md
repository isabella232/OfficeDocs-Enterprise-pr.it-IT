...
|:-----|:-----|:-----|
|Condividere i calendari con un'altra organizzazione di Office 365  <br/> |Gli amministratori possono configurare diversi livelli di accesso al calendario di Exchange Online per consentire alle aziende di collaborare con altre aziende e per consentire agli utenti di condividere le pianificazioni (informazioni sulla disponibilità) con altri utenti  <br/> |[Condivisione in Exchange Online](https://technet.microsoft.com/en-us/library/jj916670%28v=exchg.150%29.aspx) <br/> [Relazioni dell'organizzazione in Exchange Online](https://technet.microsoft.com/en-us/library/jj916658%28v=exchg.150%29.aspx) <br/> [Creare una relazione dell'organizzazione in Exchange Online](https://technet.microsoft.com/en-us/library/jj916671%28v=exchg.150%29.aspx) <br/> [Modificare e relazione dell'organizzazione in Exchange Online](https://technet.microsoft.com/en-us/library/jj916659%28v=exchg.150%29.aspx) <br/> [Rimuovere una relazione dell'organizzazione in Exchange Online](https://technet.microsoft.com/en-us/library/jj916657%28v=exchg.150%29.aspx) <br/> [Condividere calendari con utenti esterni](https://support.office.com/article/fb00dd4e-2d5f-4e8d-8ff4-94b2cf002bdd) <br/> |
...
|**Obiettivo di condivisione**|**Azione amministrativa**|**Informazioni sulle procedure**|
|:-----|:-----|:-----|
|Skype per Online Business - messaggistica Istantanea, chiamate e presenza con altri Skype per gli utenti aziendali  <br/> |Gli amministratori possono consentire loro Skype per gli utenti aziendali Online per messaggistica immediata, effettuare chiamate audio/video e verificare la presenza con utenti in un altro tenant di Office 365.  <br/> |[Permettere agli utenti di contattare utenti Skype for Business esterni](https://support.office.com/article/b414873a-0059-4cd5-aea1-e5d0857dbc94) <br/> |
...
|**Obiettivo di condivisione**|**Azione amministrativa**|**Informazioni sulle procedure**|
|:-----|:-----|:-----|
|Power BI consente agli utenti esterni guest di utilizzare contenuto condiviso loro tramite collegamenti. In questo modo gli utenti dell'organizzazione distribuire il contenuto in modo protetto tra organizzazioni.<br/> | L'amministratore di Power BI è possibile controllare se gli utenti possono invitare utenti esterni per visualizzare il contenuto all'interno dell'organizzazione. <br/> |[Distribuire il contenuto di BI in Power BI per gli utenti esterni guest con Azure Active Directory B2B](https://docs.microsoft.com/en-us/power-bi/service-admin-azure-ad-b2b) <br/> |

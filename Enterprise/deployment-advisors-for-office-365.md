...
### <a name="exchange-migration-advisor"></a>Preparazione della migrazione di Exchange
[Advisor migrazione della posta di Office 365](http://aka.ms/office365setup) consentono di spostare le cassette postali di sistema di posta elettronica corrente a Exchange Online in Office 365 con strumenti automatici e istruzioni dettagliate. Consigliabile sarà il percorso di migrazione migliore per l'organizzazione in base al sistema di posta elettronica corrente, il numero di cassette postali che si desidera eseguire la migrazione e come si prevede di gestire utenti e l'accesso degli utenti.
...
### <a name="azure-active-directory-connect-aad-connect-advisor"></a>Advisor Azure Active Directory connettersi (connessione AAD)
...
Consente di [Preparazione di distribuzione di Microsoft Intune](https://aka.ms/intuneguidance) di impostare Intune in modo che è possibile fornire l'accesso ai dipendenti per le applicazioni aziendali, dati e le risorse da praticamente ovunque quasi qualsiasi dispositivo. Impostazione di Intune fornisce protezione dei dispositivi mobili, protezione dei dispositivi, e consente di proteggere la informazioni aziendali. Intune offre i vantaggi a Mobile Device Management (MDM) o Gestione applicazione Mobile (MAM) senza la registrazione.
...
[Preparazione distribuzione team](http://aka.ms/teamsguidance)
...
Vedere le [procedure dettagliate per gli utenti di Office 365](https://aka.ms/usertrainingwizards) per indicazioni sulle procedure, rapido su aspetti quali l'installazione di applicazioni di Office 365 su dispositivi mobili o la sincronizzazione file OneDrive for Business.
...
|**Elemento**|**Descrizione**|
|:-----|:-----|
|[![OneDrive multi-Geo nel modello a Office 365](images/c6c1b7cd-7833-46fb-9eec-c12150c260d9.png)          ](https://github.com/MicrosoftDocs/OfficeDocs-Enterprise/raw/live/Enterprise/images/Multi-Geo-ODB.pdf) <br/> [PDF](https://github.com/MicrosoftDocs/OfficeDocs-Enterprise/raw/live/Enterprise/images/Multi-Geo-ODB.pdf) \| [Visio](https://github.com/MicrosoftDocs/OfficeDocs-Enterprise/raw/live/Enterprise/images/Multi-Geo-ODB.vsdx) <br/> | Questo poster viene fornita una panoramica su una pagina di funzionalità Multi-Geo in OneDrive e SharePoint Online in Office 365. In questo modello include:<br/><br/> -Vantaggi <br/> -Procedure per la distribuzione <br/> -Un esempio di configurazione <br/><br/>  Per ulteriori informazioni sulla funzionalità Multi-Geo in OneDrive e SharePoint Online in Office 365, fare clic [qui](https://aka.ms/onedrivemultigeo).  <br/> |

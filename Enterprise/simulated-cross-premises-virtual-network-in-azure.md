...
> [!TIP]
> Fare clic [qui](https://gallery.technet.microsoft.com/PowerShell-commands-for-7844edd0) per ottenere un file di testo che contiene tutti i comandi di PowerShell in questo articolo.

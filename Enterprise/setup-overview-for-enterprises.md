...
2. **Accedere e aggiungere i domini Internet a Office 365**. Accedere all'interfaccia di [amministrazione di Microsoft 365](https://portal.microsoft.com), fare clic su **Setup > Domains**e quindi fare clic su **nuovo dominio**. Aggiungere uno o più domini alla sottoscrizione di Office 365 senza aggiungere utenti o eseguire la migrazione della posta elettronica. 

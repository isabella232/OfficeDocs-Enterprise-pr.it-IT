...
<p>Nella figura 1: Ricerca all'interno di un tenant con tre posizioni geo</p></th>
<th align="left"><p>Ricerca client chiama l'endpoint REST di ricerca con la proprietà query EnableMultiGeoSearch = true.</p>
<p>La query viene inviata a tutti i percorsi geo nel tenant.</p>
<p>Risultati di ricerca ogni località geografica vengono uniti e classificati.</p>
<p>Client ottiene risultati di ricerca unificata.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
### Ottenere un centro ricerche per visualizzare i risultati da tutti i percorsi geo
...
3.  Selezionare il verticale di configurare, fare clic sull'icona ingranaggio **Impostazioni** nell'angolo in alto a destra e quindi fare clic su **Modifica pagina**.

> ![](media/configure-search-for-multi-geo_image2.png)
>
> Verrà visualizzata la pagina dei risultati della ricerca in modalità di modifica.

1.  Nella Web Part risultati di ricerca spostare il puntatore verso l'alto a destra della Web Part fare clic sulla freccia e quindi fare clic su **Modifica Web Part** dal menu. ![](media/configure-search-for-multi-geo_image3.png)

> Riquadro degli strumenti della Web Part risultati ricerca verrà visualizzata sotto la barra multifunzione nella parte superiore destra della pagina.
...
**MultiGeoSearchStatus** -si tratta di una proprietà che restituisce l'API di ricerca di SharePoint in risposta alla richiesta. Il valore della proprietà corrisponde a una stringa e vengono fornite le informazioni seguenti relative ai risultati che restituisce l'API di ricerca di SharePoint:
...
<tr class="odd">
<td align="left">Nessuna</td>
<td align="left">La query non è stato in una query Multi-Geo e non è stata disposta in altre posizioni geo.</td>
</tr>
</tbody>
</table>

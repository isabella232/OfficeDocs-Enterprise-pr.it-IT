...
**Riepilogo:** Informazioni su come utilizzare Office 365 PowerShell per creare gli account utente in Office 365.
...
ShawnM@contoso.onmicrosoft.com,Shawn,Melendez,Shawn Melendez,US,contoso:ENTERPRISEPACK
 ...
 > [!NOTE]
>I nomi di colonna e il relativo ordine nella prima riga del file CSV sono arbitrarie, ma verificare che i dati nella parte restante del file corrispondano all'ordine dei nomi di colonna e utilizzare i nomi di colonna per i valori dei parametri nel comando PowerShell di Office 365.
...
Per utilizzare il cmdlet **New-AzureADUser** dal modulo di Azure Active Directory V2 PowerShell, è innanzitutto necessario connettersi alla sottoscrizione. Per ulteriori informazioni, vedere [Connect con il modulo di Azure Active Directory V2 PowerShell](https://go.microsoft.com/fwlink/?linkid=842218).

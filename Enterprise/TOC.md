...
#### [Fase 4 dell'autenticazione federata a disponibilità elevata: Configurare i proxy dell'applicazione Web](high-availability-federated-authentication-phase-4-configure-web-application-pro.md)
...
#### [Eseguire la pianificazione di OneDrive for Business Multi-Geo](plan-for-multi-geo.md)
...
#### [Configurazione della ricerca per OneDrive for Business Multi-Geo](configure-search-for-multi-geo.md)
...
#### [Ambiente di sviluppo e di testing PILR Office 365](GDPR-discovery-protection-reporting-in-Office365-dev-test-environment.md)
...
##### [Esportare i dati utente da Project Server](/Project/export-user-data-from-project-server?toc=/Office365/Enterprise/toc.json)
##### [Eliminare i dati utente da Project Server](/Project/delete-user-data-from-project-server?toc=/Office365/Enterprise/toc.json)
#### [PILR per il Server di Office Online](gdpr-for-office-online-server.md)
#### [PILR per le condivisioni file](gdpr-for-on-premises-file-shares.md)
...
## [Eseguire l'aggiornamento da Office 2007 o di prodotti 2010](plan-upgrade-previous-versions-office.md)

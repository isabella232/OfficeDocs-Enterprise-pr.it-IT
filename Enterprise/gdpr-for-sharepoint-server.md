...
In SharePoint Server 2013 e SharePoint Server 2016, la cronologia query e le query "preferite" scadono automaticamente dopo 365 giorni. Se un utente lascia l'organizzazione, è possibile rimuovere i riferimenti a un nome utente dalla cronologia query tramite la procedura seguente.

Le seguenti query SQL si applicano a SharePoint 2013 e SharePoint 2016 e consentono di:
...
SharePoint Server 2013 e SharePoint Server 2016 eliminano automaticamente i record di utilizzo dopo 3 anni. È possibile eliminare manualmente questi record tramite la procedura seguente:

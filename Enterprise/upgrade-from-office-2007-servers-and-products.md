...
|**Roadmap di pianificazione**|**Supporto di data fine**|
|:-----|:-----|
...
**Ha bisogno di assistenza?** Considerare l'utilizzo di un esperto delle licenze partner o volume. Vedere **[trovare un partner di Office 365 o rivenditori](https://support.office.com/article/b6c18a9b-2aed-4c84-9d75-af709160258c.aspx)**. 
> [!TIP]
> Se l'acquisto di licenze di Office 365 50 o più, il nostro team FastTrack consentono tramite il processo di installazione di Office 365. Visita il sito Web [FastTrack.Microsoft.com](https://www.microsoft.com/fasttrack/microsoft-365/office-365).
  
Se l'organizzazione dispone di meno di 50 licenze di Office 365, vedere [Admins: aggiornare gli utenti per il client Office più recente con Office 365 per aziende](https://support.office.com/article/f6b00895-b5fd-4af6-a656-b7788ea20cbb.aspx). 
  
### <a name="are-you-a-home-user"></a>Sono gli utenti privati?

Selezionare una delle opzioni seguenti:
- **Prova Office 365 per uso domestico**. Impostare una versione di valutazione gratuita per verificare il funzionamento di Office 365. [Essere più produttivi, eseguire l'aggiornamento da Office 2007 a Office 365 oggi](https://go.microsoft.com/fwlink/?linkid=733276).
    
- **Acquisto di Office 365 per uso domestico**. Scelta tra la sottoscrizione di Office 365 casa o Office 365 personale, Esegui l'iscrizione e installare la versione più recente di Office in un computer Windows o Mac, dispositivo smartphone e tablet PC. Si verrà sfruttare archiviazione cloud con OneDrive, ottenere 60 minuti di chiamate Skype per dispositivi mobili e numeri di rete fissa ogni mese e ottenere numerose altre funzionalità. 
...
## <a name="what-if-i-dont-upgrade"></a>Che cosa accade se non aggiornare?
